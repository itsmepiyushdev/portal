...
const toggleLanguge = (event) => {
    language.value.toggle(event);
};
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <button type="button" class="layout-topbar-action" @click="toggleLanguge" aria-haspopup="true" aria-controls="overlay_language">
                        <i class="pi pi-language"></i>
                        <span>Languages</span>
                    </button>
                    <Menu ref="language" id="overlay_language"   :popup="true" >
                        <template #end>
                            <div class="card flex justify-center flex-col">
                                <label for="languages" class="mb-2 text-xl">Select a Language</label>
                                <Select v-model="locale" :options="availableLocales"  placeholder="Select a Language" class="w-full md:w-56" />
                            </div>
                        </template>
                    </Menu>
                    <button type="button" class="layout-topbar-action" @click="toggleMenuProfile" aria-haspopup="true" aria-controls="overlay_menu" >
                    ...
                    <Menu ref="menu" id="overlay_menu"   :popup="true" >
                        ...
                        <template #end>
                            <ResponsiveNavLink :href="route('profile.edit')"   as="button">
                                <span class="font-bold"><span class="pi pi-cog"></span> Profile</span>
                            </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('logout')" method="post" as="button">
                                <span class="font-bold"><span class="pi pi-sign-out"></span> Logout</span>
                            </ResponsiveNavLink>
                    </template>
                    </Menu>
                </div>
