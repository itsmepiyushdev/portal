            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <InputText id="name" type="text"  v-model="form.name" placeholder="Name" class="w-full md:w-[30rem] mb-8"  />
                        <InputError  :message="form.errors.name" />

                        <label for="email" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Email</label>
                        <InputText id="email" type="email"  v-model="form.email" placeholder="Email" class="w-full md:w-[30rem] mb-8"  />
                        ...
                        <label for="password2" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Password Confirmation</label>
                        <Password id="password_confirmation" v-model="form.password_confirmation" placeholder="Password Confirmation" :toggleMask="true" class="mb-4" fluid :feedback="false"></Password>
                        ...
                        <Button label="Register"  type="submit" :class="{ 'opacity-25': form.processing }"
